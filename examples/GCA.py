...
def main():
    ...
    degree_weights = A.PageRankWeights()
    degree_weights.pin_graph(data)
    aug1 = A.Compose([A.AdaptiveEdgeRemoving(0.3, degree_weights), A.AdaptiveFeatureMasking(0.3, False, degree_weights)])
    aug2 = A.Compose([A.AdaptiveEdgeRemoving(0.3, degree_weights), A.AdaptiveFeatureMasking(0.3, False, degree_weights)])
